...
public record UserProfileResponse(
     ...
     * 从用户资料聚合创建不包含敏感字段的响应。
     *
     * @param aggregate 当前用户资料聚合
     * @return 安全的用户资料响应
     */
    public static UserProfileResponse from(UserProfileAggregate aggregate) {
        return from(aggregate.user(), aggregate.workspace(), aggregate.membership());
    }
