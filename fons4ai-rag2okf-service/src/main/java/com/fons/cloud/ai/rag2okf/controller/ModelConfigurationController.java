...
public class ModelConfigurationController {
    ...
    public R<List<ModelProfileResponse>> listProfiles() {
        return R.ok(modelConfigurationApplicationService.listProfiles());
    }
    ...
    public R<ModelProfileResponse> updateProfile(@PathVariable String profileKey,
    ...
    public R<ModelTestResponse> testProfile(@PathVariable String profileKey) {
